...
const Header = ({ user, onProfileClick, onBellClick, darkMode, onThemeChange, onNavigate }) => (
  <header className="header">
    ...
    <div className="header__icons">
      ...
      <button 
        ...
        onClick={() => {
          // Navegación a mensajes al hacer clic en la campana
          if (onNavigate) {
            onNavigate("mensajes");
          }
          // También mantener la función original por compatibilidad
          if (onBellClick) {
            onBellClick();
          }
        }}
